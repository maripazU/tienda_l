...
//esta clase se puede usar como plantilla
//rercibe cualquier tipo de imágenes, se puede ajustar el código para que acepte y guarde pdfs
...
public class FirebaseStorageServiceImpl implements FirebaseStorageService {
    ...
    //para cargar una imagen se necesitan los parámetros que vienen en esta función 
    @Override
    ...
    //vaya a buscar donde está el certificado de seguridad para que lo utilice para poder autenticarse, cual es la ruta donde se va a poner la información y finalmente se crea un espacio en la nube para guardar todos esos bytes (la imagen)
